...
//         IOManager ioManager = new IOManager();
//         Deque<Point> testGesture = recognizer.resample(ioManager.loadGesture("arrowTest.xml"), 64);
//         Double pointSum = recognizer.centroid(testGesture).getX() + recognizer.centroid(testGesture).getY();
//         assertEquals(557.084, pointSum, .001);
//     }
...
//         IOManager ioManager = new IOManager();
//         Deque<Point> testGesture = recognizer.resample(ioManager.loadGesture("arrowTest.xml"), 64);
//         recognizer.boxSize(testGesture, 200);
//         assertEquals(164.8257, recognizer.width, .001);
//         assertEquals(194.0, recognizer.height, .001);
//     }
...
//        recognizer.addTemplate("arrowTemplate.xml", templateGesture);
//        recognizer.addTemplate("circleTemplate.xml", circleTemplate);

//        Deque<Point> testGesture = ioManager.loadGesture("arrowTest.xml");

//        Templatematch bestMatch = recognizer.recognize(testGesture);
...
//        
//         Templatematch match = recognizer.recognize(templateGesture);
